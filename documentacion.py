...
S6_1 = """
<h2>6.1 La densidad del líquido y del vapor</h2>
...
uno por ciento en el rango de hidrocarburos.</p>
<p>El programa aplica la ruta seleccionada de forma consistente en todos
los puntos donde reporta densidad de líquido: el resultado del flash, la
pestaña de propiedades, la pestaña de saturación y el mapa de densidad
comparten la misma función de cálculo, de modo que un mismo estado siempre
produce el mismo valor de densidad.</p>
"""
...
temperatura reducida a través de la variable auxiliar τ = 1 − T<sub>r</sub>, y es
válida en el intervalo 0.25 &lt; T<sub>r</sub> &lt; 0.95:</p>
...
T<sub>r</sub> = 1. La densidad del líquido saturado es el peso molecular dividido
entre el volumen saturado.</p>
"""
...
la mezcla.</p>
<p>Por debajo de T<sub>r</sub> = 0.95 se aplica el método COSTALD completo con la
corrección por presión. Por encima de T<sub>r</sub> = 1.0 el método deja de tener
sentido físico y la densidad del líquido se toma directamente de la ecuación
de estado. En la banda intermedia, entre T<sub>r</sub> = 0.95 y T<sub>r</sub> = 1.0, la densidad
se interpola con un perfil cuadrático entre la densidad de líquido en
T<sub>r</sub> = 0.95 obtenida por COSTALD y la densidad de la ecuación de estado en
T<sub>r</sub> = 1.0:</p>
...
S7_4 = """
<h2>7.4 Ensamblaje por fase y validación</h2>
